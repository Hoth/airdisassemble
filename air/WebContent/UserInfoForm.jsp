  ...
  <h1>여행지를 찾아라</h1>
   <div class="question">
    ...
    <input type="text" id="txtAge" required/ value="나이"><p>
         ...
         <input type="radio" name="age" class="age" value="25"><span>24~26<p>
         <input type="radio" name="age" class="age" value="29"><span>27~29<p>
         <input type="radio" name="age" class="age" value="30"><span>30대<p>
         <input type="radio" name="age" class="age" value="40"><span>40대<p>   
         <input type="radio" name="age" class="age" value="50"><span>50대 이상<p>      
